...
//========================================================================	
	...
	function openCheckIdWindow() {
		window.open("check_id.jsp","아이디 중복확인","width=400,height=250");
	}
		  ...
		  <article>
		  	...
		  	<form action="joinPro.jsp" method="post" id="join" name="fr" onsubmit="return checkSubmit()">
		  		<fieldset>
		  			<legend></legend>
					<label>아이디</label>
		  			<input type="text" name="id" class="id" id="id" required="required" readonly="readonly" placeholder="중복확인 클릭">
		  			<!--  readonly="readonly"  중복확인하면 바로 값으 넣을 거라서 -->
		  			<input type="button" value="중복확인" class="dup" id="btn" onclick="openCheckIdWindow()"><br>
		  			
		  			<label>비밀번호</label>
		  			<input type="password" name="pass" id="pass" required="required"
		  				placeholder="영문,숫자,특수문자 8~16 글자" onkeyup="checkPass(this.value)">			
		  			...
		  			<label>E-Mail</label>
		  			<input type="email" name="email" id="email" required="required" onblur="checkEmail(this.value)"><br>
		  		</fieldset>
				...
				<fieldset>
		  			...
		  			<label>휴대폰번호</label>
		  			<input type="text" name="mobile" id="mobile" onblur="checkMobile(this.value)" ><br>
		  		</fieldset>
		  		<div class="clear"></div>
		  		<div id="buttons">
