...
int listCount = questionDAO.selectListcount();
...
//=======================================
ArrayList<QuestionBean> questionList = questionDAO.selectQuestionList(pageNum, listLimt);
	...
	<div id="wrap">
		...
		<article>
			...
			<div id="page_control">
				...
				<%if(pageNum > 1) {%>
					<a href="question.jsp?page=<%=pageNum -1 %>">이전</a>
				<%}else{%>
					이전&nbsp;
				<%}%>
				...
				<%
					...
					<%
						if(pageNum == i){%>
							&nbsp;&nbsp;<%=i %>&nbsp;&nbsp;
					<%} else{%>
						<a href="question.jsp?page=<%=i%>"><%=i %></a>
					<%}%>
				<%}%>
				...
				<%if(pageNum <maxPage) {%>
					<a href="question.jsp?page=<%=pageNum + 1 %>">다음</a>
				<%}else{%>
					다음&nbsp;
				<%}%>
